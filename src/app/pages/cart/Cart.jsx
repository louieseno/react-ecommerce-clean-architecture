        ...
        <Fragment>
            ...
            {checkoutController.productIds.length > 0 && (
                <div className={`column is-full`}>
                    <h2 className="level-item" style={{ fontWeight: "bold", fontSize: 18.0 }}>
                        Total ({checkoutController.productIds.length} items) &nbsp;
                    </h2>
                    <span className="level-item" style={{ color: "red", fontSize: 20.0 }}>
                        {formatMoney.format(checkoutController.grandTotal())}
                    </span>
                    <span className="level-item" style={{ color: "red" }}>
                        <button
                            className="button is-primary is-medium"
                            onClick={() => checkoutController.goToCheckout()}
                        >
                            Checkout
                        </button>
                    </span>
